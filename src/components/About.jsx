  ...
  return (
    <section>
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
        <ProfileCard name="Mihretu Petros" role="Frontend Specialist & IT Project Coordinator" image="/images/mihretu-petros-profile.png" bio="Designs refined, responsive interfaces with React and Tailwind CSS, focusing on usability, performance, and visual consistency across screens." />
